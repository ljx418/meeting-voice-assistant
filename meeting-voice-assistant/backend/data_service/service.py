"""Top-level orchestration service for llmwiki + graphrag."""
...
class DataService:
    """Upstream data orchestration boundary.

    This service does not reimplement llmwiki or graphrag internals.
    It owns:
    - artifact layout
    - single-ingest planning
