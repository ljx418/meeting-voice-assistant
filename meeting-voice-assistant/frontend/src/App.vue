...
function handleProcessingLog(log: ProcessingLog) {
  // 查找是否已存在相同的日志（通过timestamp和部分message匹配）
...
/* Console 日志样式 (与 FileUploader 保持一致) */
.console-log {
  background: #1e1e1e;
  border-radius: 0;
  padding: 0.5rem 1rem;
