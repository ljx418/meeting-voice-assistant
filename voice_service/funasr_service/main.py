...
启动:
    ...
    python -m funasr_service.cli serve-http --host 0.0.0.0 --port 8001
"""
...
from funasr_service.realtime.ws_server import router as realtime_router
...
app = FastAPI(
    title="Voice Service",
    description="FunASR voice service with HTTP, CLI, MCP, and realtime transports",
    version="1.0.0",
)
