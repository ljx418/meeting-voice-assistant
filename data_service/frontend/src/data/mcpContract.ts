...
export const mcpToolContracts: McpToolContract[] = [
  ...
  { name: 'knowledge_code_architecture_scale_build', group: 'Project Intelligence', required: ['workspace_id', 'codebase_id'], optional: ['snapshot_id'], status: 'stable' },
  { name: 'knowledge_code_architecture_scale_profile', group: 'Project Intelligence', required: ['workspace_id', 'codebase_id'], optional: [], status: 'stable' },
  { name: 'knowledge_code_architecture_inventory_build', group: 'Project Intelligence', required: ['workspace_id', 'codebase_id'], optional: ['snapshot_id'], status: 'stable' },
  { name: 'knowledge_code_architecture_language_facts', group: 'Project Intelligence', required: ['workspace_id', 'codebase_id'], optional: [], status: 'stable' },
  { name: 'knowledge_code_architecture_config_inventory', group: 'Project Intelligence', required: ['workspace_id', 'codebase_id'], optional: [], status: 'stable' },
  { name: 'knowledge_code_architecture_deployment_inventory', group: 'Project Intelligence', required: ['workspace_id', 'codebase_id'], optional: [], status: 'stable' },
  { name: 'knowledge_code_architecture_schema_inventory', group: 'Project Intelligence', required: ['workspace_id', 'codebase_id'], optional: [], status: 'stable' },
  { name: 'knowledge_code_architecture_taxonomy_build', group: 'Project Intelligence', required: ['workspace_id', 'codebase_id'], optional: [], status: 'stable' },
  { name: 'knowledge_code_architecture_taxonomy', group: 'Project Intelligence', required: ['workspace_id', 'codebase_id'], optional: [], status: 'stable' },
  { name: 'knowledge_code_architecture_review_queue_build', group: 'Project Intelligence', required: ['workspace_id', 'codebase_id'], optional: [], status: 'stable' },
  { name: 'knowledge_code_architecture_review_queue', group: 'Project Intelligence', required: ['workspace_id', 'codebase_id'], optional: [], status: 'stable' },
  { name: 'knowledge_code_architecture_large_project_views_build', group: 'Project Intelligence', required: ['workspace_id', 'codebase_id'], optional: [], status: 'stable' },
  { name: 'knowledge_code_architecture_large_project_view', group: 'Project Intelligence', required: ['workspace_id', 'codebase_id'], optional: ['view_id'], status: 'stable' },
  { name: 'knowledge_code_architecture_docs_build', group: 'Project Intelligence', required: ['workspace_id', 'codebase_id'], optional: ['snapshot_id'], status: 'stable' },
  { name: 'knowledge_code_architecture_docs_list', group: 'Project Intelligence', required: ['workspace_id', 'codebase_id'], optional: [], status: 'stable' },
  { name: 'knowledge_code_architecture_doc_claims_build', group: 'Project Intelligence', required: ['workspace_id', 'codebase_id'], optional: [], status: 'stable' },
  { name: 'knowledge_code_architecture_doc_claims', group: 'Project Intelligence', required: ['workspace_id', 'codebase_id'], optional: [], status: 'stable' },
  { name: 'knowledge_code_architecture_doc_quality_build', group: 'Project Intelligence', required: ['workspace_id', 'codebase_id'], optional: [], status: 'stable' },
  { name: 'knowledge_code_architecture_doc_quality', group: 'Project Intelligence', required: ['workspace_id', 'codebase_id'], optional: [], status: 'stable' },
  { name: 'knowledge_code_architecture_doc_code_alignment_build', group: 'Project Intelligence', required: ['workspace_id', 'codebase_id'], optional: [], status: 'stable' },
  { name: 'knowledge_code_architecture_doc_code_alignment', group: 'Project Intelligence', required: ['workspace_id', 'codebase_id'], optional: [], status: 'stable' },
  { name: 'knowledge_code_architecture_reconstructed_build', group: 'Project Intelligence', required: ['workspace_id', 'codebase_id'], optional: [], status: 'stable' },
  { name: 'knowledge_code_architecture_reconstructed', group: 'Project Intelligence', required: ['workspace_id', 'codebase_id'], optional: [], status: 'stable' },
  { name: 'knowledge_code_architecture_doc_view', group: 'Project Intelligence', required: ['workspace_id', 'codebase_id'], optional: ['view_id'], status: 'stable' },
