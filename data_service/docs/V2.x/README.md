...
This folder contains V2 project intelligence planning, target architecture, acceptance, audit, and phase-specific development documents.

## Primary V2.0 Documents

- `V2_0_TARGET_PRD.md`
- `V2_0_TARGET_ARCHITECTURE.md`
- `V2_0_TARGET_ACCEPTANCE_PLAN.md`
- `V2_0_PHASE_2_7_DEVELOPMENT_AND_ACCEPTANCE_PLAN.md`
- `V2_0_CLOSURE_AUDIT_REPORT.md`

## Primary V2.1 Documents

- `V2_1_TARGET_PRD.md`
- `V2_1_TARGET_ARCHITECTURE.md`
- `V2_1_DEVELOPMENT_AND_ACCEPTANCE_PLAN.md`
- `V2_1_DOCUMENT_AUDIT_REPORT.md`
- `V2_1_CLOSURE_AUDIT_REPORT.md`
- `V2_1_TARGET_STATE.drawio`
- `V2_1_SELF_AUDIT_RESULT.html`

## Primary V2.4 Documents

V2.4 is the current target planning line for code-derived architecture inference.

- `V2_4_TARGET_PRD.md`
- `V2_4_TARGET_ARCHITECTURE.md`
- `V2_4_DEVELOPMENT_AND_ACCEPTANCE_PLAN.md`
- `V2_4_GAP_ANALYSIS.md`
- `V2_4_DOCUMENT_AUDIT_REPORT.md`
- `V2_4_TARGET_STATE.drawio`

## Primary V2.5 Documents

V2.5 is the ResearchNotebook backend contract and provider-specific execution line for URL hardening, provider-gated capabilities, unified ResearchNotebook artifacts, local provider closure, and full original PRD closure planning.

V2.5 has two acceptance layers:

- V2.5A local provider closure: accepted for local Tesseract image OCR, espeak-ng audio, OpenXML PPTX, and provider-disabled fallback.
- V2.5B full ResearchNotebook backend PRD closure: planned Phase 37-42 work for scanned PDF OCR, executable provider adapters, external TTS/OCR decisions, download contract closure, and final PRD coverage.

- `V2_5_RESEARCH_NOTEBOOK_BACKEND_PRD.md`
- `V2_5_RESEARCH_NOTEBOOK_BACKEND_ARCHITECTURE.md`
- `V2_5_RESEARCH_NOTEBOOK_BACKEND_DEVELOPMENT_AND_ACCEPTANCE_PLAN.md`
- `V2_5_PROVIDER_SPECIFIC_GAP_ANALYSIS.md`
- `V2_5_FULL_PRD_CLOSURE_PLAN.md`
- `V2_5_FULL_PRD_CLOSURE_ACCEPTANCE_PLAN.md`
- `V2_5_FULL_PRD_DOCUMENT_AUDIT_REPORT.md`
- `V2_5_RESEARCH_NOTEBOOK_BACKEND_DOCUMENT_AUDIT_REPORT.md`
- `V2_5_TARGET_STATE.drawio`
- `V2_5_PHASE_32_DEVELOPMENT_PLAN.md`
- `V2_5_PHASE_32_ACCEPTANCE_PLAN.md`
- `V2_5_PHASE_32_AUDIT_REPORT.md`
- `V2_5_PHASE_33_DEVELOPMENT_PLAN.md`
- `V2_5_PHASE_33_ACCEPTANCE_PLAN.md`
- `V2_5_PHASE_33_AUDIT_REPORT.md`
- `V2_5_PHASE_34_DEVELOPMENT_PLAN.md`
- `V2_5_PHASE_34_ACCEPTANCE_PLAN.md`
- `V2_5_PHASE_34_AUDIT_REPORT.md`
- `V2_5_PHASE_35_DEVELOPMENT_PLAN.md`
- `V2_5_PHASE_35_ACCEPTANCE_PLAN.md`
- `V2_5_PHASE_35_AUDIT_REPORT.md`
- `V2_5_PHASE_36_DEVELOPMENT_PLAN.md`
- `V2_5_PHASE_36_ACCEPTANCE_PLAN.md`
- `V2_5_PHASE_36_AUDIT_REPORT.md`

## Primary V2.6 Documents

V2.6 is the large-scale architecture abstraction hardening line for Project Intelligence. It extends V2.4 code-derived architecture inference with scale profiling, lightweight multi-language/config facts, taxonomy governance, review queues, large-project views, and Agent Context Pack architecture summaries.

V2.6 does not reopen V2.5 ResearchNotebook backend closure and does not claim full static analysis, full call graph, data flow, control flow, runtime tracing, or type inference.

- `V2_6_TARGET_PRD.md`
- `V2_6_TARGET_ARCHITECTURE.md`
- `V2_6_DEVELOPMENT_AND_ACCEPTANCE_PLAN.md`
...
V2 phase development, acceptance, and audit documents use this naming pattern:

- `V2_PROJECT_INTELLIGENCE_PHASE_{N}_DEVELOPMENT_PLAN.md`
- `V2_PROJECT_INTELLIGENCE_PHASE_{N}_ACCEPTANCE_PLAN.md`
- `V2_PROJECT_INTELLIGENCE_PHASE_{N}_AUDIT_REPORT.md`

Current V2.0 acceptance is governed by `docs/V2.x/V2_0_TARGET_PRD.md` and related V2.0 target documents. The broader `V2_PROJECT_INTELLIGENCE_PRD.md` remains a product vision reference unless explicitly cited by a phase plan.

Current V2.1 final closure is accepted for the current worktree.

Closure evidence:

- `V2_PROJECT_INTELLIGENCE_PHASE_11_IMPLEMENTATION_ACCEPTANCE_REPORT.md`
- `V2_PROJECT_INTELLIGENCE_PHASE_12_AUDIT_REPORT.md`
- `V2_1_CLOSURE_AUDIT_REPORT.md`

V2.4 planning authority:

- Product authority: `V2_4_TARGET_PRD.md`
- Architecture authority: `V2_4_TARGET_ARCHITECTURE.md`
- Execution and acceptance authority: `V2_4_DEVELOPMENT_AND_ACCEPTANCE_PLAN.md`
- Gap analysis: `V2_4_GAP_ANALYSIS.md`
- Document audit: `V2_4_DOCUMENT_AUDIT_REPORT.md`

V2.5 planning and acceptance authority:

- Product authority: `V2_5_RESEARCH_NOTEBOOK_BACKEND_PRD.md`
- Architecture authority: `V2_5_RESEARCH_NOTEBOOK_BACKEND_ARCHITECTURE.md`
- Execution and acceptance authority: `V2_5_RESEARCH_NOTEBOOK_BACKEND_DEVELOPMENT_AND_ACCEPTANCE_PLAN.md`
- Gap analysis: `V2_5_PROVIDER_SPECIFIC_GAP_ANALYSIS.md`
- Document audit: `V2_5_RESEARCH_NOTEBOOK_BACKEND_DOCUMENT_AUDIT_REPORT.md`
- Full PRD closure plan: `V2_5_FULL_PRD_CLOSURE_PLAN.md`
- Full PRD closure acceptance: `V2_5_FULL_PRD_CLOSURE_ACCEPTANCE_PLAN.md`
- Full PRD closure document audit: `V2_5_FULL_PRD_DOCUMENT_AUDIT_REPORT.md`
- Target state diagram: `V2_5_TARGET_STATE.drawio`
- Phase 32 provider safety implementation: `V2_5_PHASE_32_DEVELOPMENT_PLAN.md`, `V2_5_PHASE_32_ACCEPTANCE_PLAN.md`, `V2_5_PHASE_32_AUDIT_REPORT.md`
- Phase 33 OCR provider implementation: `V2_5_PHASE_33_DEVELOPMENT_PLAN.md`, `V2_5_PHASE_33_ACCEPTANCE_PLAN.md`, `V2_5_PHASE_33_AUDIT_REPORT.md`
- Phase 34 TTS/audio provider implementation: `V2_5_PHASE_34_DEVELOPMENT_PLAN.md`, `V2_5_PHASE_34_ACCEPTANCE_PLAN.md`, `V2_5_PHASE_34_AUDIT_REPORT.md`
- Phase 35 PPTX export implementation: `V2_5_PHASE_35_DEVELOPMENT_PLAN.md`, `V2_5_PHASE_35_ACCEPTANCE_PLAN.md`, `V2_5_PHASE_35_AUDIT_REPORT.md`
- Phase 36 provider-specific closure: `V2_5_PHASE_36_DEVELOPMENT_PLAN.md`, `V2_5_PHASE_36_ACCEPTANCE_PLAN.md`, `V2_5_PHASE_36_AUDIT_REPORT.md`
- Phase 37 Pre-Gate provider execution contract: `V2_5_PHASE_37_PRE_GATE_DEVELOPMENT_PLAN.md`, `V2_5_PHASE_37_PRE_GATE_ACCEPTANCE_PLAN.md`, `V2_5_PHASE_37_PRE_GATE_AUDIT_REPORT.md`
- Phase 37 scanned PDF OCR: `V2_5_PHASE_37_SCANNED_PDF_OCR_DEVELOPMENT_PLAN.md`, `V2_5_PHASE_37_SCANNED_PDF_OCR_ACCEPTANCE_PLAN.md`, `V2_5_PHASE_37_SCANNED_PDF_OCR_AUDIT_REPORT.md`
- Phase 38 provider adapter hardening: `V2_5_PHASE_38_PROVIDER_ADAPTER_HARDENING_DEVELOPMENT_PLAN.md`, `V2_5_PHASE_38_PROVIDER_ADAPTER_HARDENING_ACCEPTANCE_PLAN.md`, `V2_5_PHASE_38_PROVIDER_ADAPTER_HARDENING_AUDIT_REPORT.md`
- Phase 39 Minimax TTS: `V2_5_PHASE_39_EXTERNAL_TTS_DEVELOPMENT_PLAN.md`, `V2_5_PHASE_39_EXTERNAL_TTS_ACCEPTANCE_PLAN.md`, `V2_5_PHASE_39_EXTERNAL_TTS_AUDIT_REPORT.md`, `V2_5_PHASE_39_TTS_PROVIDER_DECISION.json`
- Phase 40 external OCR decision: `V2_5_PHASE_40_EXTERNAL_OCR_DEVELOPMENT_PLAN.md`, `V2_5_PHASE_40_EXTERNAL_OCR_ACCEPTANCE_PLAN.md`, `V2_5_PHASE_40_EXTERNAL_OCR_AUDIT_REPORT.md`, `V2_5_PHASE_40_OCR_PROVIDER_DECISION.json`
- Phase 41 download contract closure: `V2_5_PHASE_41_DOWNLOAD_CONTRACT_DEVELOPMENT_PLAN.md`, `V2_5_PHASE_41_DOWNLOAD_CONTRACT_ACCEPTANCE_PLAN.md`, `V2_5_PHASE_41_DOWNLOAD_CONTRACT_AUDIT_REPORT.md`, `V2_5_PHASE_41_DOWNLOAD_CONTRACT_DECISION.json`
- Phase 42 full closure audit: `V2_5_PHASE_42_CLOSURE_AUDIT_DEVELOPMENT_PLAN.md`, `V2_5_PHASE_42_CLOSURE_AUDIT_ACCEPTANCE_PLAN.md`, `V2_5_PHASE_42_CLOSURE_AUDIT_REPORT.md`, `V2_5_FULL_PRD_COVERAGE_MATRIX.md`
