...
- V2.0 acceptance is governed by `docs/V2_0_TARGET_PRD.md`, not the older broad V2 PRD unless explicitly referenced.
...
- Before starting Phase 2, create `docs/V2_PROJECT_INTELLIGENCE_PHASE_2_DEVELOPMENT_PLAN.md`, `docs/V2_PROJECT_INTELLIGENCE_PHASE_2_ACCEPTANCE_PLAN.md`, and `docs/V2_PROJECT_INTELLIGENCE_PHASE_2_AUDIT_REPORT.md`.
