...
```bash
rg "旧会议应用从属定位|旧终端用户产品定位|旧 Phase 5.7 UI 名称" README.md backend/README.md docs/data_service backend/data_service/KNOWLEDGE-PROJECT-OVERVIEW.md
```
...
```bash
rg "MCP-first|Knowledge Governance Service|服务治理控制台|workspace_id|root_path|最小可分" README.md backend/README.md docs/data_service backend/data_service/KNOWLEDGE-PROJECT-OVERVIEW.md
```
