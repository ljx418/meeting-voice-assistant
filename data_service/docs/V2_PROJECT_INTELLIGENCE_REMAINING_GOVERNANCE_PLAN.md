...
- 阶段开发计划：`docs/V2_PROJECT_INTELLIGENCE_PHASE_{N}_DEVELOPMENT_PLAN.md`
- 阶段验收计划：`docs/V2_PROJECT_INTELLIGENCE_PHASE_{N}_ACCEPTANCE_PLAN.md`
- 阶段审计报告：`docs/V2_PROJECT_INTELLIGENCE_PHASE_{N}_AUDIT_REPORT.md`
