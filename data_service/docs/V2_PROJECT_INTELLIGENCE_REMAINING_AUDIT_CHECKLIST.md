...
- `docs/V2_PROJECT_INTELLIGENCE_PRD.md`
- `docs/V2_PROJECT_BASELINE.md`
- `docs/V2_PROJECT_INTELLIGENCE_REMAINING_DEVELOPMENT_PLAN.md`
- `docs/V2_PROJECT_INTELLIGENCE_REMAINING_ACCEPTANCE_PLAN.md`
- `docs/V2_PROJECT_INTELLIGENCE_REMAINING_GOVERNANCE_PLAN.md`

For each concrete phase, also audit:

- `docs/V2_PROJECT_INTELLIGENCE_PHASE_{N}_DEVELOPMENT_PLAN.md`
- `docs/V2_PROJECT_INTELLIGENCE_PHASE_{N}_ACCEPTANCE_PLAN.md`
- `docs/V2_PROJECT_INTELLIGENCE_PHASE_{N}_AUDIT_REPORT.md`
