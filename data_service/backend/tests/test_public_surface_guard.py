...
def test_v16a_knowledge_cli_parser_matches_v15_public_surface_baseline():
    ...
    expected_nested["code"] = ["architecture", "archive", "coding-agent", "context-pack", "describe", "devwiki", "graph", "import", "inventory", "list", "overview", "quality", "snapshot", "symbols", "trace"]
