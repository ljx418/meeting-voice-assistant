...
from .mcp_core_tools import CORE_TOOL_NAMES, CORE_TOOL_SPECS, handle_core_tool
from .models import QueryMode
from .mcp_quality_tools import QUALITY_TOOL_NAMES, QUALITY_TOOL_SPECS, RULE_STATUSES, handle_quality_tool
from .mcp_session_tools import SESSION_TOOL_NAMES, SESSION_TOOL_SPECS, handle_session_tool
...
async def list_tools() -> List[Tool]:
    return [
        *[Tool(**spec) for spec in CORE_TOOL_SPECS],
        *[Tool(**spec) for spec in QUALITY_TOOL_SPECS],
        Tool(
        ...
        *[Tool(**spec) for spec in SESSION_TOOL_SPECS],
    ]
