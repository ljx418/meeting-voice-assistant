"""Generate V4-U7 UX-10 provider-backed engineering workflow evidence."""
...
OUTPUT_DIR = U7_EVIDENCE_ROOT / "UX-10-engineering-workflow"


def main() -> int:
    result = run_engineering_workflow_runtime()
