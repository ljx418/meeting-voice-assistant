"""Generate V4-U7 UX-09 provider-backed deliberation evidence."""
...
OUTPUT_DIR = U7_EVIDENCE_ROOT / "UX-09-parallel-deliberation"


def main() -> int:
    result = run_parallel_deliberation_runtime()
