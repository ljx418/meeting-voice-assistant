...
from core.engine.messages import ConversationMessage, TextBlock, ToolResultBlock
from core.engine.query import (
    AskUserPrompt,
    PermissionPrompt,
    QueryContext,
    remember_user_goal,
...
from core.engine.stream_events import AssistantTurnComplete, StreamEvent
...
class QueryEngine:
    ...
    async def submit_message(self, prompt: str | ConversationMessage) -> AsyncIterator[StreamEvent]:
        ...
        if self._hook_executor is not None:
            from core.engine.hooks import HookEvent
...
# Import type hints at module level
from typing import TYPE_CHECKING

if TYPE_CHECKING:
    from core.engine.policies import PermissionChecker
    from core.engine.tools.base import ToolRegistry
    from core.engine.hooks import HookExecutor
    from core.engine.query import SupportsStreamingMessages
