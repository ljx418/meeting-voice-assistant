...
from core.config.paths import get_config_dir
from core.coordinator.agent_definitions import (
    AGENT_COLORS,
    EFFORT_LEVELS,
    ISOLATION_MODES,
    MEMORY_SCOPES,
...
from core.plugins.schemas import PluginManifest
from core.plugins.types import LoadedPlugin, PluginCommandDefinition
from core.skills.loader import _parse_skill_markdown
...
def _load_plugin_hooks(path: Path) -> dict[str, list]:
    ...
    if not path.exists():
        return {}
    from core.hooks.schemas import (
        AgentHookDefinition,
