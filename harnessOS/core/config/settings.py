...
from core.hooks.schemas import HookDefinition
from core.mcp.types import McpServerConfig
from core.permissions.modes import PermissionMode
from core.utils.file_lock import exclusive_file_lock
from core.utils.fs import atomic_write_text
...
class Settings(BaseModel):
    ...
    def resolve_auth(self) -> ResolvedAuth:
        ...
        if auth_source in {"codex_subscription", "claude_subscription"}:
            from core.auth.external import (
                is_third_party_anthropic_endpoint,
                load_external_credential,
            )
            from core.auth.storage import load_external_binding
        ...
        from core.auth.storage import load_credential
...
def load_settings(config_path: Path | None = None) -> Settings:
    ...
    if config_path is None:
        from core.config.paths import get_config_file_path
