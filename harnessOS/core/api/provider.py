...
from core.auth.external import describe_external_binding
from core.auth.storage import load_external_binding
from core.api.registry import detect_provider_from_registry
...
def auth_status(settings: Settings) -> str:
    ...
    if settings.api_format == "copilot":
        from core.api.copilot_auth import load_copilot_auth
