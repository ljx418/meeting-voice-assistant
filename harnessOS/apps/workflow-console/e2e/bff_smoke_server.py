...
from tests.v4_0_reference_support import build_gateway, seed_reference_console  # noqa: E402

os.environ.setdefault("HARNESS_V3_5_DEV_MODE", "1")
os.environ.setdefault("HARNESS_CAPABILITY_TOKEN_SECRET", "browser-smoke-secret")
LOCAL_ORIGINS.add("http://127.0.0.1:4174")
LOCAL_ORIGINS.add("http://localhost:4174")
