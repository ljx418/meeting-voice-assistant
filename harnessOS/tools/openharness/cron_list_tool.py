...
from examples.open_harness.src.openharness.services.cron import load_cron_jobs
from examples.open_harness.src.openharness.services.cron_scheduler import is_scheduler_running
...
class CronListToolInput(BaseModel):
    ...
    pass  # PyDantic accepts empty model
