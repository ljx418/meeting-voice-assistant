...
class FileWriteTool(BaseTool):
    ...
    async def execute(
        ...
        from examples.open_harness.src.openharness.sandbox.session import is_docker_sandbox_active

        if is_docker_sandbox_active():
            from examples.open_harness.src.openharness.sandbox.path_validator import validate_sandbox_path
