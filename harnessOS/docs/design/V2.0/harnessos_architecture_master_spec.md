...
flowchart TB
    ...
    subgraph Protocol["Protocol App Server Layer"]
    ...
    subgraph Core["Harness Core Layer"]
        SM["Session Manager"]
    ...
    subgraph Packs["Domain Pack Layer"]
        MEET["Meeting Pack"]
        KNOW["Knowledge Pack"]
    ...
    subgraph Connectors["Connector / MCP / Tool Plane"]
